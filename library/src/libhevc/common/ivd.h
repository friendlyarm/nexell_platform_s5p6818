...
typedef struct {
     ...
     */
    uint8_t             *pu1_bufs[IVD_VIDDEC_MAX_IO_BUFFERS];

    /**
     * sizes of each output buffer
     */
    uint32_t            u4_min_out_buf_size[IVD_VIDDEC_MAX_IO_BUFFERS];
...
typedef struct {
     ...
     */
    uint32_t                                    u4_num_disp_bufs;

    /**
     * no of input buffers required for codec
     */
    uint32_t                                    u4_min_num_in_bufs;

    /**
     * no of output buffers required for codec
     */
    uint32_t                                    u4_min_num_out_bufs;

    /**
     * sizes of each input buffer required
     */
    uint32_t                                    u4_min_in_buf_size[IVD_VIDDEC_MAX_IO_BUFFERS];
...
typedef struct {
     ...
     * frame_rate
     */
    uint32_t                 u4_frame_rate;

    /**
     * u4_bit_rate
     */
    uint32_t                 u4_bit_rate;
...
typedef struct {
     ...
     * version_buffer_size
     */
    uint32_t                                    u4_version_buffer_size;
